...
\begin{proof}
    ...
    \begin{align*}
        ...
        &\le \int_a^b |f_n(x)-f(x)|\d{x}&(\text{Integral Triangle Inequality})\\
        &\le (b-a)\|f_n-f\|_\infty,&(\text{Lemma \ref{lem:integralestimate}})
    \end{align*}
